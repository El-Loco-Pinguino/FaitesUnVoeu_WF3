...
$w_config = [
	//url
	'base_url' => '/FaitesUnVoeu_WF3/public',		//chemin relatif au domaine, menant à la racine de l'appli

   	//information de connexion à la bdd
	'db_host' => 'localhost',						//hôte (ip, domaine) de la bdd
    'db_user' => 'WF3',								//nom d'utilisateur pour la bdd
    'db_pass' => 'CREMeCq3nmLJpsXG',				//mot de passe de la bdd
    'db_name' => 'FUV',								//nom de la bdd
